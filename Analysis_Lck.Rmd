...
Let's focus on the TRB now. No NKT sequence removal is applied in this case. We will keep only the information whether the CDR3 sequence is present in the sample or not (i.e., we will keep only unique occurrences). We will loop through all the samples and calculate the percentage of overlapping sequences.
